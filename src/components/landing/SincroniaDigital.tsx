  ...
  return (
    <section className="bg-background py-14 lg:py-20">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="mt-8 grid grid-cols-1 items-start gap-8 md:grid-cols-[0.8fr_1.2fr]">
          ...
          <div>
            <h3 className="text-lg font-bold leading-snug text-cocoa">
              Deja de ser el cuello de botella de tu propio crecimiento.
            </h3>
            <p className="mt-4 text-justify text-sm leading-relaxed text-muted-foreground">
              Implementamos una infraestructura "All-in-One" impulsada por Inteligencia Artificial y
              tecnología de vanguardia. Unificamos tu marketing y tus ventas en un solo sistema
              automatizado para que tu negocio funcione 24/7 sin depender de tu respuesta manual.
            </p>
            <a
              href="#contacto"
        ...
        <h3 className="mt-14 text-center text-base font-bold text-cocoa">Lo que logramos por ti:</h3>

        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-3">
          {results.map(({ icon: Icon, title, text }) => (
            <div key={title}>
              <Icon className="h-9 w-9 text-cocoa" strokeWidth={1.4} aria-hidden="true" />
