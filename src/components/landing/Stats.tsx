		...
		<section className='bg-background pb-14 pt-10 lg:pb-20'>
			<div className='mx-auto max-w-4xl px-6 text-center'>
				...
				<p className='mx-auto mt-4 max-w-xl text-sm leading-relaxed text-muted-foreground'>
					En Raíz Creativa te acompañamos a conectar, crecer y vender
					con una marca personal coherente, auténtica y profesional.
					Creamos estrategias visuales, digitales y emocionales desde
					el primer contacto.
				</p>
				<a
				...
				<div className='mt-10 grid grid-cols-1 gap-4 sm:grid-cols-3'>
					{stats.map(({ value, label }) => (
						<div
							key={value}
							className='rounded-xl border-2 border-brand px-4 py-5 text-left'
						>
				...
				<p className='mx-auto mt-8 max-w-xl text-sm leading-relaxed text-muted-foreground'>
					Hoy en Raíz Creativa, toda esta trayectoria se convierte en
					un sistema estratégico y personalizado para marcas
